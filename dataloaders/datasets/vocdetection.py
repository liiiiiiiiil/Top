...
class VOCDETECTION(Dataset):
    ...
    def __init__(self,
        ...
        self._image_dir_val = os.path.join('/home/xupeihan/deeplab/test/', 'val')
        self._cat_dir_val = os.path.join('/home/xupeihan/deeplab/test/', 'label')
    ...
    def __getitem__(self, index):
        ...
        for split in self.split:
            if split == "train":
                ...
                # label2 = _target.resize((512,512),Image.BILINEAR)
                # label2 = np.array(label2).astype(np.float32)
                # label2 = torch.from_numpy(label2).float()
                return self.transform_val(sample),w,h, self.images[index]
...
if __name__ == '__main__':
    ...
    voc_train = VOCDETECTION(args, split='train')
